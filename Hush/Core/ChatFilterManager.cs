...
namespace Hush.Core
{
    ...
    public class ChatFilterManager
    {
        ...
        public void Save(string filePath)
        {
            ...
            _log.LogInfo($"Saved filter config ({_blockedWords.Count} words, {_rawPatterns.Count} patterns) to: {filePath}");
        }
        ...
        public void Load(string filePath)
        {
            ...
            {
                _log.LogInfo("No filter config file found, starting fresh.");
                return;
            }
            FilterConfig? dto;
            try
            ...
            RebuildPattern();
            _log.LogInfo($"Loaded filter config: {_blockedWords.Count} words, {_rawPatterns.Count} patterns.");
        }
        ...
        private void RebuildPattern()
        {
            ...
            _log.LogDebug($"Pattern rebuilt: {Count} active entries.");
        }
    }
}
